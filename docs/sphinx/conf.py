...
try:
    ...
    __version__ = get_package_version(__file__, "sdss-hal") or "dev"
...
.. |hal_version| replace:: {__version__}
"""
...
htmlhelp_basename = "{0}pdoc".format("hal")
...
man_pages = [(master_doc, "hal", "{0} Documentation".format(project), [author], 1)]
